           ...
           <div className="accordion" id="accordionExample-a">
               <div className="accordion-item bdr0">
                   <h2 className="accordion-header" id="heading-b">
                     <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1a" aria-expanded="true" aria-controls="collapseOne">
                       Incomprehensibility or readability? That is the question.
                     </button>
                   </h2>
                   <div id="collapse-1a" className="accordion-collapse collapse show" aria-labelledby="heading-b" data-bs-parent="#accordionExample-a">
                     <div className="accordion-body">
                       <div className="data-reqs">								
                           <h5 className="pb20">Content List</h5>
                           <p>5 Years Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>								
                 ...
                 <div className="accordion-item bdr0">
                   <h2 className="accordion-header" id="heading-c">
                     <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2a" aria-expanded="true" aria-controls="collapseOne">
                       Origin and meaning of the Lorem Ipsum text
                     </button>
                   </h2>
                   <div id="collapse-2a" className="accordion-collapse collapse" aria-labelledby="heading-c" data-bs-parent="#accordionExample-a">
                     <div className="accordion-body">
                       <div className="data-reqs">
                           <h5 className="pb20">Content List</h5>
                           <p>5 Years Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>								
